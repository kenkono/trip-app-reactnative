...
import {
  ...
  Image, AsyncStorage, Dimensions, ActivityIndicator } from 'react-native';
import { Button } from 'react-native-elements';

const SCREEN_WIDTH = Dimensions.get('window').width;
const SLIDE_DATA = [
  { title: 'Step: 1', text: 'Add your trip memory', url: require('../assets/welcome_screen1.jpg') },
  { title: 'Step: 2', text: 'All tips on the list', url: require('../assets/welcome_screen2.jpg') },
  { title: 'Step: 3', text: 'See the trip detail!', url: require('../assets/welcome_screen3.jpg') }
];
